...
(function() {
    ...
    $.fn.stick_in_parent = function(opts) {
        ...
        _fn = function(elm, padding_bottom, parent_top, parent_height, top, height) {
            ...
            var defaultOffset = elm.data("offset"); // added by YinJianFeng
            if(defaultOffset == undefined) defaultOffset = 0; // added by YinJianFeng
            parent = elm.parent();
            if (parent_selector != null) {
...
//                top = elm.offset().top - parseInt(elm.css("margin-top"), 10);// commented by YinJianFeng
                top = elm.offset().top - defaultOffset;// added by YinJianFeng
            ...
            bottomed = false;
            last_pos = void 0;
            offset = defaultOffset;  //Updated by YinJianFeng, original value is 0;
            reset_width = false;
            tick = function() {
                ...
                last_pos = scroll;
                if (fixed) {
//                    will_bottom = scroll + height + offset > parent_height + parent_top; // commented by YinJianFeng
                    will_bottom = scroll + height + offset > parent.height() + parent_top;
                ...
                if (fixed) {
                    if (will_bottom == null) {
//                        will_bottom = scroll + height + offset > parent_height + parent_top; // commented by YinJianFeng
                        will_bottom = scroll + height + offset > parent.height() + parent_top;// duplicated by YinJianFeng
                    }
                    if (!bottomed && will_bottom) {
                        bottomed = true;

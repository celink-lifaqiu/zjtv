...
//			// 获得摘要
//			byte[] source = DigestUtil.MdigestSHA("假设这是要加密的客户数据");
...
//				System.out.print("匹配成功 合法的签名!");
			...
			System.out.println("==================================");
			System.out.println(new String(kp.getPublic().getEncoded()));
			System.out.println("==================================");
			System.out.println(new String(kp.getPrivate().getEncoded()));
			System.out.println("==================================");
			// 获得摘要
			byte[] source1 = DigestUtil.MdigestSHA("aaaaa");
			System.out.println(new String(source1));
